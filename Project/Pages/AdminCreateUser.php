...
<?php
        ...
        move_uploaded_file($profilePictureTmpName, '../Images/Users/' . $profilePictureName);


        $query = "INSERT INTO tblusers (name , email , password ,profilePicture , userType) VALUES ('$name' , '$email' , '$password' , '$profilePictureName' , $userType)";
...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        <input type="submit" class="btn btn-primary" value="Create Account" name="CreateAccount">
    </div>
